...
void PooMachine::loadSprites(Graphics& gfx)
{
	...
	poo_green	= &gfx.MakeSprite(L"../Art/Node_Green.png", { 0,0,12,12 }, 4.0f, { 16.0f,24.0f });
	poo_purple	= &gfx.MakeSprite(L"../Art/Node_Purple.png", { 0,0,12,12 }, 4.0f, { 16.0f,24.0f });
	poo_red		= &gfx.MakeSprite(L"../Art/Node_Red.png", { 0,0,12,12 }, 4.0f, { 16.0f,24.0f });
